# ![](https://raw.githubusercontent.com/phlummox-dev/gotty/master/resources/favicon.png) GoTTY - Share your terminal as a web application

[![GitHub release](http://img.shields.io/github/release/phlummox-dev/gotty.svg?style=flat-square)][release]
[![Wercker](http://img.shields.io/wercker/ci/55d0eeff7331453f0801982c.svg?style=flat-square)][wercker]
[![MIT License](http://img.shields.io/badge/license-MIT-blue.svg?style=flat-square)][license]

[release]: https://github.com/phlummox-dev/gotty/releases
[wercker]: https://app.wercker.com/project/bykey/03b91f441bebeda34f80e09a9f14126f
[license]: https://github.com/phlummox-dev/gotty/blob/master/LICENSE

GoTTY is a simple command line tool that turns your CLI tools into web applications.

![Screenshot](https://raw.githubusercontent.com/phlummox-dev/gotty/master/screenshot.gif)

# Installation

Download the latest stable binary file from the [Releases](https://github.com/phlummox-dev/gotty/releases) page. Note that the release marked `Pre-release` is built for testing purpose, which can include unstable or breaking changes. Download a release marked [Latest release](https://github.com/phlummox-dev/gotty/releases/latest) for a stabale build.
...
```sh
$ brew install phlummox-dev/gotty/gotty
```
...
```sh
$ go get github.com/phlummox-dev/gotty
```
...
See the [`.gotty`](https://github.com/phlummox-dev/gotty/blob/master/.gotty) file in this repository for the list of configuration options.
